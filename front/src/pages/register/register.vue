<template>
	<div class="form-signin bg-dark p-3 rounded-3 anime-signin-text">
		<form class="needs-validation">
			...
			<div v-bind:value="email" v-on:change="email_input" class="form-floating">
				<input type="email" class="form-control rounded-0" id="email_input" value="name@example.com">
				<label for="floatingInput" class="text-dark">
					Email address
				</label>
			</div>
			...
			<button @click="register" type="button" id="register_button" class="btn btn-primary anime-navbar-text w-100 ">
				Register
			</button>
		</form>

		<a href="/signin.html">
			<button class="w-100 btn btn-secondary btn-lg mt-2" type="submit">
				Log In
			</button>
		</a>
